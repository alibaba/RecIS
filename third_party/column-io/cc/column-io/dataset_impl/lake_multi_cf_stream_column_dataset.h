#ifndef _COLUMN_IO_CC_COLUMN_IO_DATASET_IMPL_LAKE_MULTI_CF_STREAM_COLUMN_DATASET_H_
#define _COLUMN_IO_CC_COLUMN_IO_DATASET_IMPL_LAKE_MULTI_CF_STREAM_COLUMN_DATASET_H_
#include <cstddef>
#include <map>
#include <memory>
#include <string>
...
namespace column {
namespace dataset {
class LakeMultiCFStreamColumnDatase {
public:
  static Status ParseConfig(const std::string &config,
