#ifndef _COLUMN_IO_CC_COLUMN_IO_DATASET_IMPL_OPEN_STORAGE_DATASET_H_
#define _COLUMN_IO_CC_COLUMN_IO_DATASET_IMPL_OPEN_STORAGE_DATASET_H_
#include <cstddef>
#include <map>
#include <memory>
#include <string>
